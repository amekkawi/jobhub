 ...
 * @param {JobForkError~options} [options] - Additional detail to include with the error.
 * @property {string} jobName - The name of the job.
 ...
 * @param {Error|*} original - The successful result or the original Error.
...
/**
 * Values for JobWorkerHandlerError#type
 * @enum {string}
 */
