 ...
 * @fires TrackedJob#event:jobStarted
 * @fires TrackedJob#event:jobForked
 * @fires TrackedJob#event:jobProgress
 * @fires TrackedJob#event:jobSuccess
 * @fires TrackedJob#event:jobFailure
 * @class
 */
...
/**
 * @event TrackedJob#event:jobStarted
 */

/**
 * @event TrackedJob#event:jobForked
 */

/**
 * @event TrackedJob#event:jobProgress
 * @type {object|*}
 */

/**
 * @event TrackedJob#event:jobSuccess
 * @type {object|*|null|undefined}
 */

/**
 * @event TrackedJob#event:jobFailure
 * @type {Error}
 */
